...
def custom_tokenize(text, mode="lemma"):
    """
    Tokenizes, deletes the words that aren't fully alphabetical and apply a lemmatiser or a stemmatizer
    ...
    if mode == "lemma":
        ...
        stemm_eng = SnowballStemmer()
        tokens = udf.lem_string(words, lemmatizer=stemm_eng)
    else:
